...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'] ?? '')) {
        ...
        try {
            ...
            $image_url = admin_upload_image('image_file', 'products');
            ...
            $stmt->bind_param('ssisddisi', $name, $slug, $category_id, $description, $price, $compare_price, $stock, $image_url, $is_bestseller);
            $stmt->execute();
...
<div>
<h2 class="text-display-lg font-display-lg text-primary">Create Product</h2>
<p class="text-body-lg text-on-surface-variant mt-2">Add a catalogue item with a local uploaded image.</p>
</div>
...
<?php $submit_label = 'Create Product'; require __DIR__ . '/includes/product-form.php'; ?>
</section>
</main>
</body>
</html>
