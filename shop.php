...
<div class="max-w-container-max mx-auto px-gutter py-8 lg:py-12">
  <!-- Breadcrumb -->
  <nav class="flex items-center gap-2 text-label-sm text-outline mb-8">
    <a href="<?= BASE_URL ?>/index.php" class="hover:text-primary transition-colors">Home</a>
    <span class="material-symbols-outlined text-[16px]">chevron_right</span>
    <span class="text-primary font-medium">Shop All</span>
  </nav>
  ...
  <div class="flex flex-col lg:flex-row gap-10 relative">
    ...
    <!-- Sidebar Filter -->
    <aside id="filter-sidebar" class="w-full lg:w-72 flex-shrink-0 lg:sticky lg:top-28 lg:self-start lg:block hidden lg:block">
...
input[type="range"]::-webkit-slider-thumb {
  ...
  background: #012d1d;
  cursor: pointer;
  box-shadow: 0 2px 6px rgba(1, 45, 29, 0.3);
}
...
// Mobile responsive: make sidebar a slide-in drawer only on small screens
