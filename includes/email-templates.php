...
function getReminderEmailHtml($type, $userName) {
    $templates = [
        'medicine' => [
            'subject' => 'दवा लेने का समय - AyurViora',
            'icon' => 'Rx',
        ...
        'water' => [
            'subject' => 'पानी पीने की याद - AyurViora',
            'icon' => 'H2O',
            'title' => 'पानी पीएँ',
...
<div style="display:inline-flex;align-items:center;justify-content:center;min-width:72px;height:72px;border-radius:20px;background:rgba(255,255,255,0.16);color:white;font-size:20px;font-weight:800;letter-spacing:.04em;margin-bottom:14px;">{$t['icon']}</div>
...
<p style="margin: 0; font-size: 14px; color: #735c00;"><strong>Tip:</strong> {$t['tip']}</p>
</div>
<hr style="border: none; border-top: 1px solid #e0e0e0; margin: 20px 0;">
<p style="font-size: 12px; color: #999; text-align: center;">© AyurViora — Ancient Wisdom for Modern Living</p>
</div>
</div>
</body>
</html>
