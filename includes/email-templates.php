...
function getReminderEmailHtml($type, $userName) {
    $templates = [
        'medicine' => [
            'subject' => '🌿 दवा लेने का समय - Ayurviro',
            'icon' => '💊',
        ...
        'water' => [
            'subject' => '💧 पानी पीने की याद - Ayurviro',
            'icon' => '💧',
            'title' => 'पानी पीएँ',
...
<p style="font-size: 12px; color: #999; text-align: center;">© Ayurviro — Ancient Wisdom for Modern Living</p>
</div>
</div>
</body>
</html>
